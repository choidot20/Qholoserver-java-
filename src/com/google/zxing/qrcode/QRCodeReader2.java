...
import com.google.zxing.datamatrix.detector.Detector2;
 ...
 * @author Sean Owen
 */
public class QRCodeReader2 implements Reader {
  ...
  public Result decode(BinaryBitmap image, Map<DecodeHintType,?> hints)
   ...
   // 코드의 .. 갯수 볼려고 추가 
    ...
    //*
    System.out.println("Qrcodereader2.java DetectorResult2 들어감KYT 들어간다KYT201512");
    
    DetectorResult2 detectorResult = new Detector2(image.getBlackMatrix()).detect(); //패턴을 찾아 좌표를 리턴하여 이미지 정렬및 비트 추출
    BitMatrix bits = new BitMatrix(10,10);
  //  Log.d("decoderResult들거마", "decoderResult 들어간다");
    decoderResult = decoder.decode(bits);//detectorResult.getBits() -> bits 를 리턴함 
  //  Log.d("pointst들거마", "points 들어간다");
    //points = detectorResult.getPoints();
    points = NO_POINTS;
 // 코드의 .. 갯수 볼려고 추가 
    System.out.println("codeReader2실행 포인트갯수 :"+points.length+"  hints :"+hints);
